...
/**
 * @brief  DTPMV  performs one of the matrix-vector operations
 *       x := A*x,   or   x := A**T*x,
*/
extern "C" MATHLIBRARY_API void  cblas_dtpmv(char uplo, char trans, char diag, int n, double* ap, double* x, int incx);

/***
 * @brief  DTPSV  solves one of the systems of equations
 *       A*x = b,   or   A**T*x = b,
*/
extern "C" MATHLIBRARY_API void cblas_dtpsv(char uplo, char trans, char diag, int n, double* ap, double* x, int incx);
...
extern "C" MATHLIBRARY_API void cblas_dgemmtr(char uplo, char transa, char transb, int n, int k, double alpha, double* pA, int lda,
	double* pB, int ldb, double beta, double* pC, int ldc);
...
extern "C" MATHLIBRARY_API void clapack_dlarft(char direct, char storev, int n, int k, double* pV, int ldv,
 ...
 */
extern "C" MATHLIBRARY_API void clapack_dlarfb(char side, char trans, char direct, char storev,
	int m, int n, int k, double* v, int ldv, double* t,
	int ldt, double* pC, int ldc, double* work, int ldwork);

extern "C" MATHLIBRARY_API void clapack_dgeqrf(int	m, int n, double* pA, int lda, double* tau, double* work, int lwork, int& info);
 ...
 * @return
*/
extern "C" MATHLIBRARY_API void clapack_dpotrf(char uplo, int n, double* A, int lda, int info);

extern "C" MATHLIBRARY_API void clapack_dpotrf2(char uplo, int n, double* A, int lda, int info);

extern "C" MATHLIBRARY_API void clapack_dpotrs(char UPLO, int n, int nrhs, double* A, int lda, double* B, int ldb, int INFO);

extern "C" MATHLIBRARY_API void clapack_dposv(char uplo, int n, int nrhs, double* a, int lda, double* b, int ldb, int& info);
...
*/
extern "C" MATHLIBRARY_API void dlaset(char uplo, int m, int n, double alpha,
	double beta, double* pA, int lda);

/***
\brief DLACPY copies all or part of one two-dimensional array to another.
*/
extern "C" MATHLIBRARY_API void cblas_dlacpy(char uplo, int m, int n, double* pA, int lda, double* pB, int ldb);
...
extern "C" MATHLIBRARY_API void showMatrix_d(double* data, int rows, int columns, int lda = 0);

extern "C" MATHLIBRARY_API void print_int_vector(const char* desc, int n, int* a); 

extern "C" MATHLIBRARY_API void print_matrix(const char* desc, int m, int n, double* a, int lda);
